...
export const USER: User = {
  ...
  about: `
Hello, World! I am Smae Tongmenglay (nickname Jose) — a Senior Frontend Developer passionate about creating seamless, user-centric web and mobile applications with intuitive and engaging designs.
